        ...
        public String builder(CouchMetaDriver couchDriver, etype[] parms, boolean implementation) {
            ...
            String s =
                    "{\n"
                            ...
                            + "            }\n"
                            + "            return null;\n" + "          }";
            return (implementation ? "public " : "") + CouchResultSet.class.getCanonicalName() + " "
                    + name() + "()" + (implementation ? s : ";");
        }
    },
    /**
     * returns resultset from the assumed Future<couchTx>
    ...
    pojo {
        public String builder(CouchMetaDriver couchDriver, etype[] parms, boolean implementation) {
            ...
            return (implementation ? " public " : "")
                    ...
                    + "()"
                    + (implementation ? "{ \n" + "try {\n" + "        return ("
                    + ByteBuffer.class.getCanonicalName() + ") rxf.server.driver.CouchMetaDriver."
                    + couchDriver + ".visit();\n" + "      } catch (Exception e) {\n"
                    + "        e.printStackTrace();   \n" + "      } " + "        return null;} " : ";");
        }
    },
        ...
        public String builder(CouchMetaDriver couchDriver, etype[] parms, boolean implementation) {
            ...
            String s =
                    "{\n    try{\n"
                            ...
                            + "}catch(Exception e){\n" + "    e.printStackTrace();\n" + "}\n"
                            + "    return null;\n}";
            return (implementation ? " public " : "") + " String  json()" + (implementation ? s : ";");
        }
    };
