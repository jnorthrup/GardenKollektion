@file:Suppress("EnumEntryName", "SpellCheckingInspection", "unused")
...
enum class MimeType(
   ...
   /** `%`*/`$25` ("application/x-trash"),
    /**`~`*/`$7e` ("application/x-trash"),
    art ("image/x-jg"),
    asc ("text/plain"),
    asf ("video/x-ms-asf"),
    ...
    otf ("application/font-sfnt" ,"font/otf" ,"font/sfnt","font/ttf"),
    ...
    `pcf$2eZ` ("application/x-font-pcf"),
    pcx ("image/pcx"),
    pdb ("chemical/x-pdb"),
    pdf ("application/pdf"),
    ...
    ttc ("font/collection"),
    ttf ("application/font-sfnt","font/otf"  ,"font/sfnt",  "font/ttf"),
    ttl ("text/turtle"),
    txt ("text/plain"),
